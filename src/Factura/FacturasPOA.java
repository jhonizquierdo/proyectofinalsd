                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // Factura/Facturas/insertarFactura
       {
         ...
         $result = this.insertarFactura (id_cliente, id_producto, id_vendedor, fecha, matricula);
         out = $rh.createReply();
       ...
       case 1:  // Factura/Facturas/actualizarFactura
       {
         ...
         String matricula = in.read_wstring ();
         boolean $result = false;
         $result = this.actualizarFactura (id_factura, id_cliente, id_producto, id_vendedor, fecha, matricula);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
